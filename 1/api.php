...
try{
	...
	$lead = $api_connector->create(array(
		'name'			=> $_POST['name'],
		'phone'			=> $_POST['phone'],
		'offer_id'		=> '2024',                         // offer_id из ЛК
		'stream_id'		=> '56038',                         // Optional, stream_id 
		'country' 		=> 'HR',                            // Country in format https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
		'tz' 			=> '',
		'address' 		=> '',
...
{
    public $config = array(
        'api_key' => '8e704663f943f8b3ce30f80f815e0861',                                     		// api_key of user
        'user_id' =>  '14714',                                                              		// user_id
